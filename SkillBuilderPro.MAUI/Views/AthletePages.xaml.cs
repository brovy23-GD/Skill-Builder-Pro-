...
public partial class TrainingPage:ContentPage,IQueryAttributable
{
 ...
 void TrainingStageSizeChanged(object? s,EventArgs e){var phone=TrainingStage.Width>0&&TrainingStage.Width<700;TrainingContent.Padding=phone?new Thickness(16,18,16,28):new Thickness(22);((TrainingViewModel)BindingContext).UpdateViewport(TrainingStage.Width,TrainingStage.Height);}
